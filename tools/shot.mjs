...
await p.goto(`http://127.0.0.1:${process.env.PORT || 5174}/${query}`, { waitUntil: 'load' });
...
if (!process.env.HUD) await p.addStyleTag({ content: '#screen,#hud,#mute,#hint,#toast,#status,#levelup,.rival-tag{display:none!important}' });
