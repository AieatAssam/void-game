// Balance sweep: node tools/balance.mjs [extraQuery] [seconds]  -> one line per seed x mode (greedy/sloppy)
...
const [extra = '', seconds = '420', seedList = '777,11,23,42,99,2024'] = process.argv.slice(2);
const seeds = seedList.split(',');
const jobs = seeds.flatMap((s) => [[s, '0'], [s, '1']]);
const summary = (out) => {
