...
def build():
    p = [box('hut', (1.8, 1.6, 1.3), loc=(0, 0, 2.6), color='white', bev=0.1),
         ...
         box('deck', (2.6, 2.0, 0.12), loc=(0.3, 0, 1.9), color='clay', bev=0.03),
         box('ramp', (2.4, 0.8, 0.08), loc=(1.9, 0, 0.95), color='clay', bev=0.02, rot=(0, 0.8, 0)),
    ...
    for x in (-0.7, 0.7):
        for y in (-0.6, 0.6):
            p.append(box(f'leg{x}{y}', (0.12, 0.12, 1.9), loc=(x, y, 0.95), color='clay', bev=0.03))
