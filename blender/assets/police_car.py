...
def build():
    ...
    p += [box('door', (1.7, 2.04, 0.34), loc=(-0.1, 0, 0.62), color='police', bev=0.08),
          box('hood', (0.9, 1.6, 0.04), loc=(1.5, 0, 0.294 + 0.62 + 0.01), color='police', bev=0.015),
          box('bar', (0.5, 1.4, 0.14), loc=(-0.6, 0, car_top() + 0.06), color='ink', bev=0.05),
    ...
    beacon.location = (-0.6, 0, car_top() + 0.2)
    parent(beacon, root)
