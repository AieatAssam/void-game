...
def build():
    p = [lathe('tower', [(0.0, 0.0), (3.2, 0.0), (3.2, 0.6), (2.8, 0.8), (2.0, 11.0), (2.3, 11.2), (0.0, 11.4)], color='cream', seg=32),
         ...
         box('balcony', (1.8, 5.8, 0.2), loc=(2.2, 0, 6.0), color='clay', bev=0.05)]
    ...
    for k in range(4):
        a = k * math.pi / 2
        b.append(box(f'spar{k}', (0.15, 0.25, 8.0), loc=(0.5, math.sin(a) * 4, math.cos(a) * 4), color='clay', bev=0.04, rot=(-a, 0, 0)))
